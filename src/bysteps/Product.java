...
public abstract class Product implements Item, Comparable<Product>{
	...
	/* (non-Javadoc)
	 * @see bysteps.Item#setProductionNumber(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bysteps.Item#setName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bysteps.Item#getManufactureDate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bysteps.Item#getSerialNumber()
	 */
	@Override
